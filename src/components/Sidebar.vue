  ...
  <div class="flex">
    ...
    >
      ...
      <nav class="mt-10">
        ...
        <router-link
          class="flex items-center duration-200 mt-4 py-2 px-6 border-l-4"
          :class="[$route.name === 'Events' ? activeClass : inactiveClass]"
          to="/events"
        >
          <svg
            class="h-5 w-5"
        ...
        >
          ...
          <span class="mx-4">Peserta</span>
        </router-link>

        <router-link
          class="flex items-center duration-200 mt-4 py-2 px-6 border-l-4"
          :class="[$route.name === 'Bookers' ? activeClass : inactiveClass]"
          to="/bookers"
        >
          ...
          <span class="mx-4">Pemesan</span>
        </router-link>

        <router-link
          class="flex items-center duration-200 mt-4 py-2 px-6 border-l-4"
          :class="[$route.name === 'Kategori' ? activeClass : inactiveClass]"
          to="/categories"
        >
          <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
            <path
          ...
          <span class="mx-4">Kategori Event</span>
        </router-link>
        ...
        <router-link
          class="flex items-center duration-200 mt-4 py-2 px-6 border-l-4"
          :class="[$route.name === 'Tiket' ? activeClass : inactiveClass]"
          to="/tickets"
        >
          <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
            <path
          ...
          <span class="mx-4">Tiket</span>
        </router-link>

        <router-link
          class="flex items-center duration-200 mt-4 py-2 px-6 border-l-4"
          :class="[$route.name === 'Vouchers' ? activeClass : inactiveClass]"
          to="/vouchers"
        >
          <svg
            class="h-5 w-5"
          ...
          <span class="mx-4">Vouchers</span>
        </router-link>

        <router-link
          class="flex items-center duration-200 mt-4 py-2 px-6 border-l-4"
          :class="[$route.name === 'Sertifikat' ? activeClass : inactiveClass]"
          to="/certificates"
        >
          <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
            <path
          ...
          <span class="mx-4">Sertifikat</span>
        </router-link>

        <router-link
          class="flex items-center duration-200 mt-4 py-2 px-6 border-l-4"
          :class="[$route.name === 'Pemateri' ? activeClass : inactiveClass]"
          to="/pemateri"
        >
          <svg
            class="h-5 w-5"
