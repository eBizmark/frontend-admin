        ...
        <div class="modal-content py-4 text-left px-6">
          ...
          <form class="w-full max-w-lg" @submit.prevent>
            <div class="md:flex md:items-center mb-6">
              ...
              <div class="md:w-3/4">
                <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-indigo-500" id="inline-full-name" type="text" placeholder="Masukkan nama event">
              </div>
            </div>
            <div class="md:flex md:items-center mb-6">
              <div class="md:w-1/4">
              ...
              <div class="inline-block relative w-64">
                <select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                  <option disabled selected>Pilih kategori</option>
                    <option v-for="(kategori, index) in dataKategori" :key="index">
                      {{ kategori.nama }}
                    </option>
                </select>
            ...
            <div class="md:flex md:items-center mb-6">
              ...
              <div class="flex flex-row h-10 w-40 rounded-lg relative bg-transparent mt-1">
                <button @click="decreaseNumber" class=" bg-gray-300 text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-full w-20 rounded-l cursor-pointer outline-none">
                  <span class="m-auto text-2xl font-thin">−</span>
                </button>
                <input type="text" class="outline-none focus:outline-none text-center w-full bg-gray-100 font-semibold text-md hover:text-black focus:text-black  md:text-basecursor-default flex items-center text-gray-700" name="custom-input-number" v-bind:value="maxPeserta">
                <button @click="increaseNumber" class="bg-gray-300 text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-full w-20 rounded-r cursor-pointer">
                  <span class="m-auto text-2xl font-thin">+</span>
                </button>
              </div>
            </div>
            <div class="md:flex md:items-center mb-6">
              ...
              <div class="inline-block relative w-64">
                <select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                  <option disabled selected>Pilih pemateri</option>
                    <option v-for="(pemateri, index) in dataPemateri" :key="index">
                      {{ pemateri.nama }}
                    </option>
                </select>
                <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">
