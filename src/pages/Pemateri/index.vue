                ...
                >
                    ...
                    <div class="modal-content py-4 text-left px-8">
                        ...
                        <div class="flex justify-between items-center pb-3">
                            <p class="text-2xl font-bold">Buat Pemateri</p>
                            <div
                        ...
                        <!--Body-->
                        <form class="w-full max-w-lg lg:ml-9 lg:mt-3" @submit.prevent="createPemateri">
                            ...
                            <div class="flex justify-end pt-2">
                                <button
                                    type="button"
                                    @click="open = false"
                                    class="px-6 py-3 bg-transparent p-4 rounded-lg text-indigo-500 hover:bg-gray-100 hover:text-indigo-400 mr-2"
                                >
                                    Tutup
                                </button>
                                <button
...
export default defineComponent({
  setup() {
    ...
    const createPemateri = async () => {
      await axios.post('/pemateri', formData)
